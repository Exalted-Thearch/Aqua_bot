...
const nexusCommands = [
  ...
  //   .setName('create_role')
  //   .setDescription('Create your custom role (Boosters only)')
  //   .addStringOption(o => o.setName('name').setDescription('Role Name').setRequired(true))
  //   .addStringOption(o => o.setName('hex_color').setDescription('Main Color (e.g. #FF0000)').setRequired(true))
  //   .addStringOption(o => o.setName('secondary_hex').setDescription('Gradient finish color (Optional)')),

  // new SlashCommandBuilder()
  //   .setName('edit_role')
  //   .setDescription('Edit your custom role details')
  //   .addStringOption(o => o.setName('name').setDescription('New Role Name'))
  //   .addStringOption(o => o.setName('hex_color').setDescription('New Main Color'))
  //   .addStringOption(o => o.setName('secondary_hex').setDescription('New Gradient Color'))
  //   .addAttachmentOption(o => o.setName('icon').setDescription('New Role Icon')),
new SlashCommandBuilder()
        .setName('role') 
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(o => o.setName('hex_color').setDescription('Hex color').setRequired(true))
                .addStringOption(o => o.setName('secondary_hex').setDescription('Secondary hex for Gradient Color'))
        )
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(o => o.setName('hex_color').setDescription('New Color'))
                .addStringOption(o => o.setName('secondary_hex').setDescription('New Gradient'))
                .addAttachmentOption(o => o.setName('icon').setDescription('New Icon'))
        ),

  new SlashCommandBuilder()
    .setName('grant_exception')
    .setDescription('Admin: Allow non-booster to create a role')
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator|| PermissionFlagsBits.ManageGuild)
    .addUserOption(o => o.setName('user').setDescription('The user').setRequired(true))
    .addIntegerOption(o => o.setName('months').setDescription('Duration in months').setRequired(true)),

  new SlashCommandBuilder()
    .setName('assign_role')
    .setDescription('Admin: Assign an existing role to a user')
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator || PermissionFlagsBits.ManageGuild || PermissionFlagsBits.ManageRoles)
    .addUserOption(o => o.setName('user').setDescription('The user').setRequired(true))
...
(async () => {
  try {
    ...
    if (nexusServerId) {
        console.log(`Registering ${nexusCommands.length} commands to Nexus Server...`);
        await rest.put(
            Routes.applicationGuildCommands(clientId, nexusServerId),
            { body: nexusCommands }
        );
    }
    ...
    if (grimoireServerId && generalCommands.length > 0) {
        console.log(`Registering ${generalCommands.length} commands to Grimoire Server...`);
        await rest.put(
    ...
    console.log(`Registering ALL ${allTestCommands.length} commands to Test Server...`);
    await rest.put(
